                    ...
                    <form action="{{ route($userRole . '.special.update', ['special'=>$special->id]) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                ...
                                <input type="text" name="name" id="name" class="form-control" value="{{ $special->name }}">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <label for="remarks" class="form-label">Remarks:</label>
                                <input type="text" name="remarks" id="remarks" class="form-control" value="{{ $special->remarks }}">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-lg-12">
