<div class="modal fade" id="createProgram" tabindex="-1" aria-labelledby="createProgramLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- form -->
            <form method="POST" action="{{ route('superadmin.program.store') }}">
                @csrf
                <!-- modal header -->
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="createProgramLabel">Program creation</h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            name="name" value="{{ old('name') }}" placeholder="Program name"
